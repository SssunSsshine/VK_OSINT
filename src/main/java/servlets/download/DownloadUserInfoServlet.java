...
public class DownloadUserInfoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, IOException {
        ...
        List<String> locations = CastService.castList(session.getAttribute("location"),String.class);
        List<WallpostFull> posts = CastService.castList(session.getAttribute("notes"), WallpostFull.class);
        ...
        fileRepository.userToFile(user, locations, posts, uploadPath + File.separator + fileName);
